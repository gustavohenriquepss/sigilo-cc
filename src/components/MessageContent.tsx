...
const MessageContent: React.FC<MessageContentProps> = ({ message, messagePayload, onExpire }) => {
  const expiresAt = new Date(messagePayload.createdAt).getTime() + (messagePayload.ttl * 1000);
